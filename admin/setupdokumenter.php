...
if(isset($_POST['simpan'])){
        ...
        if($_POST['no']=="AUTO"){ //tambah
                ...
                $field[4][1]="PathDok";
                $field[4][2]="'".$_POST['pathdok']."'";
		$field[5][1]="Publish";
                $field[5][2]="'".$_POST['publish']."'";
                $field[6][1]="";
                $field[6][2]="";
                generate_query("insert",$field,"tw_dokumen","","");
        }
        else{ //edit
                if($gambar=="")
		...
		$field[5][1]="Publish";
                ...
                $field[6][1]="";
                $field[6][2]="";
                generate_query("update",$field,"tw_dokumen","where ID='".$_POST['no']."'","");
                if(isset($_GET['no'])){
                        $_GET['no']="";
                }
        }
...
if(isset($_POST['pub'])){
        $field[1][1]="Publish";
        $field[1][2]="'0'";
        generate_query("update",$field,"tw_dokumen","","");
        while(list($key, $value)=each($_POST['publish'])){
                $field[1][1]="Publish";
                $field[1][2]="'1'";
                generate_query("update",$field,"tw_dokumen","where ID='".$value."'","");
        }
}

if(isset($_GET['hapus'])){
        if($_GET['no']!=""){
                generate_query("delete","","tw_dokumen","where ID='".$_GET['no']."'","");
        }
        if(isset($_GET['no'])){
                $_GET['no']="";
        }
...
if(isset($_GET['edit'])){
        if($_GET['no']!=""){
                $result1= mysql_query("select * from tw_dokumen where ID='".$_GET['no']."'");
                $row1=mysql_fetch_row($result1);
        }
}

$result = mysql_query("select * from tw_dokumen order by ID desc");
...
?>
									...
									<script language="JavaScript">
										...
										// ak_wysiwyg_generator();  
                                                        ...
                                                        <tr>
                                                                ...
                                                                <td class="rapet">
                                                                        <input type="text" name="pathdok" size="40" class="tekshitam" value="<?php
                                                                        if(isset($_GET['edit'])){
                                                                                echo $row1[3];
                                                                        }
                                                                        ?>">
							...
							<tr>
								...
								<td>
                                                                ...
                                                                <td>
                                                                        <a href="setupdokumenter.php?edit=1&no=<?php echo $row[0]?>" class="link">Edit</a>
                                                                </td>
                                                                <td>
                                                                        <a href="setupdokumenter.php?hapus=1&no=<?php echo $row[0]?>" class="link">Delete</a>
                                                                </td>
                                                                <td>
