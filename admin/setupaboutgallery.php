...
if(isset($_POST['simpan'])){
        ...
        if($_POST['no']=="AUTO"){ //tambah
                $no=ambilnomor("ID","tw_aboutgallery","","0000");
                $field[1][1]="ID";
                $field[1][2]="'".$no."'";
                $field[2][1]="Judul";
                ...
                $field[5][1]="";
                $field[5][2]="";
                generate_query("insert",$field,"tw_aboutgallery","","");
        }
        else{ //edit
                if($gambar=="")
                ...
                $field[5][1]="";
                $field[5][2]="";
                generate_query("update",$field,"tw_aboutgallery","where ID='".$_POST['no']."'","");
                if(isset($_GET['no'])){
                        $_GET['no']="";
                }
        }
...
if(isset($_POST['pub'])){
        $field[1][1]="Publish";
        $field[1][2]="'0'";
        generate_query("update",$field,"tw_aboutgallery","","");
        while(list($key, $value)=each($_POST['publish'])){
                $field[1][1]="Publish";
                $field[1][2]="'1'";
                generate_query("update",$field,"tw_aboutgallery","where ID='".$value."'","");
        }
}

if(isset($_GET['hapus'])){
        if($_GET['no']!=""){
                generate_query("delete","","tw_aboutgallery","where ID='".$_GET['no']."'","");
        }
        if(isset($_GET['no'])){
                $_GET['no']="";
        }
...
if(isset($_GET['edit'])){
        if($_GET['no']!=""){
                $result1= mysql_query("select * from tw_aboutgallery where ID='".$_GET['no']."'");
                $row1=mysql_fetch_row($result1);
        }
}

$result = mysql_query("select * from tw_aboutgallery order by ID desc");
										...
										// ak_wysiwyg_generator();  
                                                ...
                                                <table  bgcolor="#333333" cellspacing="1" border="0" width="80%">
                                                        ...
                                                        <tr bgcolor="#FDFDFD" class="tekshitam" valign="top">
                                                                ...
                                                                <td>
                                                                        <a href="setupaboutgallery.php?edit=1&no=<?php echo $row[0]?>" class="link">Edit</a>
                                                                </td>
                                                                <td>
                                                                        <a href="setupaboutgallery.php?hapus=1&no=<?php echo $row[0]?>" class="link">Delete</a>
                                                                </td>
                                                                <td>
